...
description: Best practices for writing Claude Code skills. Use when creating, editing, or improving SKILL.md files. Provides guidance on structure, naming, descriptions, progressive disclosure, patterns, and anti-patterns.
---

# Skill Authoring Best Practices

> **IMPORTANT**: Before authoring any skill, read this entire file in chunks to load all context.
> This file intentionally exceeds 500 lines - it's a justified exception because all content here
> is essential for writing effective skills. Do not skim; every section contains important guidance.
...
- [ ] SKILL.md body is under 500 lines (or justified exception like this file)
