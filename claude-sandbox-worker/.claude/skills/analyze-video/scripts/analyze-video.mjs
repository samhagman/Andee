 ...
 *
 * Usage: node analyze-video.mjs <video-path> [prompt]
 *
 * Examples:
 *   node analyze-video.mjs /media/123/456/videos/abc.mp4
 *   node analyze-video.mjs /media/123/456/videos/abc.mp4 "What happens in this video?"
 *
...
if (!videoPath) {
  console.error("Usage: node analyze-video.mjs <video-path> [prompt]");
  console.error(
    'Example: node analyze-video.mjs /media/123/videos/abc.mp4 "Summarize this video"'
  );
  process.exit(1);
}
